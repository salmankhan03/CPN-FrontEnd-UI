                                        ...
                                        return (
                                            <tr key={index} className='p-3' >
                                                <td className='align-middle pt-5  pb-5'>
                                                    ...
                                                    <ImageComponent src={item?.image[0]?.name} alt="Product Image" width={true} classAtribute="carts-img" />
                                                    {/* </div>
                                ...
                                <div className="text-left" style={{ padding: 25 }}>
                                    ...
                                    <div className='mt-4'>
                                        <InputComponent
                                            ...
                                            required
                                        />
                                        <ButtonComponent cssClass="shopping-btn mt-3" onClick={handleApplyCoupon} label="Applay Coupon" />
